...
_lr_productions = [
  ...
  ('asignacion -> VAR ASIGNACION valor EOL','asignacion',4,'p_asignacion','main.py',27),
  ('echo -> ECHO valores EOL','echo',3,'p_echo','main.py',32),
  ('valores -> valor','valores',1,'p_valores','main.py',41),
  ('valores -> valor COMA valores','valores',3,'p_valores','main.py',42),
  ('valor -> ENTERO','valor',1,'p_valor','main.py',46),
  ('valor -> FLOTANTE','valor',1,'p_valor','main.py',47),
  ('valor -> BOOLEANO','valor',1,'p_valor','main.py',48),
  ('valor -> CADENA','valor',1,'p_valor','main.py',49),
  ('valor -> VAR','valor',1,'p_valor','main.py',50),
  ('valor -> VARIABLE_ARRAY','valor',1,'p_valor','main.py',51),
  ('valor -> operacion','valor',1,'p_valor','main.py',52),
  ('valor -> argumentologico','valor',1,'p_valor','main.py',53),
  ('operacion -> ENTERO','operacion',1,'p_operacion','main.py',58),
  ('operacion -> FLOTANTE','operacion',1,'p_operacion','main.py',59),
  ('operacion -> ENTERO operador operacion','operacion',3,'p_operacion','main.py',60),
  ('operacion -> FLOTANTE operador operacion','operacion',3,'p_operacion','main.py',61),
  ('estructuracontrol -> while','estructuracontrol',1,'p_estructuracontrol','main.py',66),
  ('estructuracontrol -> if','estructuracontrol',1,'p_estructuracontrol','main.py',67),
  ('estructuracontrol -> for','estructuracontrol',1,'p_estructuracontrol','main.py',68),
  ('while -> WHILE LPAREN condicion RPAREN LBRACE lineas RBRACE','while',7,'p_while','main.py',73),
  ('if -> IF LPAREN condicion RPAREN LBRACE lineas RBRACE','if',7,'p_if','main.py',78),
  ('if -> if else','if',2,'p_if','main.py',79),
  ('if -> if elseif else','if',3,'p_if','main.py',80),
  ('if -> if elseif','if',2,'p_if','main.py',81),
  ('elseif -> ELSEIF LPAREN condicion RPAREN LBRACE lineas RBRACE','elseif',7,'p_elseif','main.py',86),
  ('elseif -> ELSEIF LPAREN condicion RPAREN LBRACE lineas RBRACE elseif','elseif',8,'p_elseif','main.py',87),
  ('else -> ELSE LBRACE lineas RBRACE','else',4,'p_else','main.py',92),
  ('condicion -> argumentologico','condicion',1,'p_condicion','main.py',97),
  ('condicion -> argumentologico conector_logico condicion','condicion',3,'p_condicion','main.py',98),
  ('vacio -> EOL','vacio',1,'p_vacio','main.py',102),
  ('conector_logico -> AND','conector_logico',1,'p_conector_logico','main.py',112),
  ('conector_logico -> OR','conector_logico',1,'p_conector_logico','main.py',113),
  ('valor_logico -> numero','valor_logico',1,'p_valor_logico','main.py',118),
  ('valor_logico -> VAR','valor_logico',1,'p_valor_logico','main.py',119),
  ('argumentologico -> VAR operador_logico VAR','argumentologico',3,'p_argumentologico','main.py',124),
  ('argumentologico -> numero operador_logico numero','argumentologico',3,'p_argumentologico','main.py',125),
  ('argumentologico -> VAR operador_logico numero','argumentologico',3,'p_argumentologico','main.py',126),
  ('argumentologico -> VAR IGUAL BOOLEANO','argumentologico',3,'p_argumentologico','main.py',127),
  ('argumentologico -> VAR IGUAL CADENA','argumentologico',3,'p_argumentologico','main.py',128),
  ('argumentologico -> VAR DIFERENTE BOOLEANO','argumentologico',3,'p_argumentologico','main.py',129),
  ('argumentologico -> VAR DIFERENTE CADENA','argumentologico',3,'p_argumentologico','main.py',130),
  ('argumentologico -> numero operador_logico VAR','argumentologico',3,'p_argumentologico','main.py',131),
  ('argumentologico -> BOOLEANO IGUAL VAR','argumentologico',3,'p_argumentologico','main.py',132),
  ('argumentologico -> CADENA IGUAL VAR','argumentologico',3,'p_argumentologico','main.py',133),
  ('argumentologico -> CADENA IGUAL CADENA','argumentologico',3,'p_argumentologico','main.py',134),
  ('argumentologico -> CADENA DIFERENTE VAR','argumentologico',3,'p_argumentologico','main.py',135),
  ('argumentologico -> CADENA DIFERENTE CADENA','argumentologico',3,'p_argumentologico','main.py',136),
  ('argumentologico -> BOOLEANO','argumentologico',1,'p_argumentologico','main.py',137),
  ('numero -> ENTERO','numero',1,'p_numero','main.py',142),
  ('numero -> FLOTANTE','numero',1,'p_numero','main.py',143),
  ('operador_logico -> IGUAL','operador_logico',1,'p_operador_logico','main.py',148),
  ('operador_logico -> DIFERENTE','operador_logico',1,'p_operador_logico','main.py',149),
  ('operador_logico -> MENOR','operador_logico',1,'p_operador_logico','main.py',150),
  ('operador_logico -> MAYOR','operador_logico',1,'p_operador_logico','main.py',151),
  ('operador_logico -> MENOR_IGUAL','operador_logico',1,'p_operador_logico','main.py',152),
  ('operador_logico -> MAYOR_IGUAL','operador_logico',1,'p_operador_logico','main.py',153),
  ('comentario -> COMNT','comentario',1,'p_comentario','main.py',159),
  ('operador -> SUMA','operador',1,'p_operador','main.py',163),
  ('operador -> RESTA','operador',1,'p_operador','main.py',164),
  ('operador -> MULT','operador',1,'p_operador','main.py',165),
  ('operador -> DIV','operador',1,'p_operador','main.py',166),
  ('operador -> POT','operador',1,'p_operador','main.py',167),
  ('declaracion_numeros -> VAR ASIGNACION numero EOL','declaracion_numeros',4,'p_declaracion_numeros','main.py',177),
  ('array -> VAR ASIGNACION ARRAY LPAREN elementos RPAREN EOL','array',7,'p_array','main.py',180),
  ('elementos -> lista','elementos',1,'p_elementos','main.py',183),
  ('elementos -> diccionario','elementos',1,'p_elementos','main.py',184),
  ('diccionario -> CADENA ASIGNACION MAYOR valor_dic','diccionario',4,'p_diccionario','main.py',187),
  ('diccionario -> CADENA ASIGNACION MAYOR valor COMA diccionario','diccionario',6,'p_diccionario','main.py',188),
  ('valor_dic -> numero','valor_dic',1,'p_valor_dic','main.py',191),
  ('valor_dic -> CADENA','valor_dic',1,'p_valor_dic','main.py',192),
  ('lista -> palabras','lista',1,'p_lista','main.py',195),
  ('lista -> numeros','lista',1,'p_lista','main.py',196),
  ('lista -> variables','lista',1,'p_lista','main.py',197),
  ('palabras -> CADENA COMA palabras','palabras',3,'p_palabras','main.py',200),
  ('palabras -> CADENA','palabras',1,'p_palabras','main.py',201),
  ('numeros -> numero COMA numeros','numeros',3,'p_numeros','main.py',204),
  ('numeros -> numero','numeros',1,'p_numeros','main.py',205),
  ('variables -> VAR COMA variables','variables',3,'p_variables','main.py',208),
  ('variables -> VAR','variables',1,'p_variables','main.py',209),
  ('funcion -> FUNCTION tipo_funcion LBRACE final_funcion RBRACE','funcion',5,'p_funcion','main.py',212),
  ('tipo_funcion -> FUNCION','tipo_funcion',1,'p_tipo_funcion','main.py',215),
  ('tipo_funcion -> VARIABLE_FUNCION','tipo_funcion',1,'p_tipo_funcion','main.py',216),
  ('final_funcion -> RETURN VAR EOL','final_funcion',3,'p_final_funcion','main.py',219),
  ('final_funcion -> lineas final_funcion','final_funcion',2,'p_final_funcion','main.py',220),
  ('cuerpo_funcion -> declaracion_numeros final_funcion','cuerpo_funcion',2,'p_cuerpo_funcion','main.py',224),
  ('cuerpo_funcion -> array final_funcion','cuerpo_funcion',2,'p_cuerpo_funcion','main.py',225),
  ('cuerpo_funcion -> estructuracontrol final_funcion','cuerpo_funcion',2,'p_cuerpo_funcion','main.py',226),
  ('readline -> READLINE LPAREN CADENA RPAREN EOL','readline',5,'p_readline','main.py',254),
  ('ingreso_datos -> VAR ASIGNACION readline','ingreso_datos',3,'p_ingreso_datos','main.py',258),
  ('objeto -> CLASE OBJETO LBRACE mas_objetos RBRACE VAR ASIGNACION NEW OBJETO LPAREN RPAREN EOL mas_atributos','objeto',13,'p_objeto','main.py',264),
  ('cuerpo_objeto -> PUBLIC VAR EOL','cuerpo_objeto',3,'p_cuerpo_objeto','main.py',269),
  ('cuerpo_objeto -> PUBLIC asignacion','cuerpo_objeto',2,'p_cuerpo_objeto','main.py',270),
  ('mas_objetos -> cuerpo_objeto','mas_objetos',1,'p_mas_objetos','main.py',275),
  ('mas_objetos -> cuerpo_objeto mas_objetos','mas_objetos',2,'p_mas_objetos','main.py',276),
  ('atributo -> VAR RESTA MAYOR ID ASIGNACION CADENA EOL','atributo',7,'p_atributo','main.py',281),
  ('mas_atributos -> atributo','mas_atributos',1,'p_mas_atributos','main.py',286),
  ('mas_atributos -> atributo mas_atributos','mas_atributos',2,'p_mas_atributos','main.py',287),
  ('for -> FOR LPAREN asignacion argumentologico EOL VAR SUMA SUMA RPAREN LBRACE lineas RBRACE','for',12,'p_for','main.py',292),
  ('for -> FOR LPAREN asignacion argumentologico EOL VAR RESTA RESTA RPAREN LBRACE lineas RBRACE','for',12,'p_for','main.py',293),
  ('linea -> ECHO CADENA EOL','linea',3,'p_linea','main.py',298),
  ('linea -> ECHO VAR EOL','linea',3,'p_linea','main.py',299),
  ('linea -> VAR ASIGNACION CADENA EOL','linea',4,'p_linea','main.py',300),
  ('linea -> estructuracontrol','linea',1,'p_linea','main.py',301),
  ('linea -> comentario','linea',1,'p_linea','main.py',302),
  ('linea -> declaracion_numeros','linea',1,'p_linea','main.py',303),
  ('linea -> array','linea',1,'p_linea','main.py',304),
  ('lineas -> linea','lineas',1,'p_lineas','main.py',309),
  ('lineas -> linea lineas','lineas',2,'p_lineas','main.py',310),
  ('expresionAritmetica -> VAR ASIGNACION numero masTerminos EOL','expresionAritmetica',5,'p_expresionAritmetica','main.py',315),
  ('expresionAritmetica -> VAR ASIGNACION VAR masTerminos EOL','expresionAritmetica',5,'p_expresionAritmetica','main.py',316),
  ('termino -> operador numero','termino',2,'p_termino','main.py',321),
  ('termino -> operador VAR','termino',2,'p_termino','main.py',322),
  ('masTerminos -> termino','masTerminos',1,'p_masTerminos','main.py',326),
  ('masTerminos -> termino masTerminos','masTerminos',2,'p_masTerminos','main.py',327),
]
